...
function App_reducer_20220328() {
    ...
    return (
        <div>
            ...
            <div>{state.users.map((data) => (
                <div>{data.id},  {data.username},   {data.age},   {data.gender}<button value={data.id} onClick={onRemove}>삭제</button></div>
            ))}</div>
...
export default App_reducer_20220328;